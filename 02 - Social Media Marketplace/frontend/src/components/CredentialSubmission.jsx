        ...
        >
          {credential.map((cred, index) => (
            ...
            >
              ...
              <input
                className="w-full px-2 py-1.5 text-sm border border-neutral-300 rounded outline-indigo-400"
                type="text"
                value={cred.value}
                onChange={(e) =>
                  setCredential((prev) =>
              ...
              />
              <X
                className="w-5 h-5 text-neutral-500 hover:text-neutral-700 cursor-pointer"
                onClick={() =>
          ...
          <div className="flex items-center gap-2">
            ...
            <button
              ...
              type="button"
              className="flex items-center gap-2 text-sm text-neutral-600 hover:text-gray-700 cursor-pointer"
            >
