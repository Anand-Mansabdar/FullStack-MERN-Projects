      ...
      >
        ...
        <div className="flex items-center gap-4 mt-3">
          <a href="#" target="_blank" rel="noreferrer">
            <DribbbleIcon className="size-5 hover:text-rose-500" />
          </a>
          <a href="#" target="_blank" rel="noreferrer">
            <LinkedinIcon className="size-5 hover:text-rose-500" />
          </a>
          <a href="#" target="_blank" rel="noreferrer">
            <TwitterIcon className="size-5 hover:text-rose-500" />
          </a>
          <a href="#" target="_blank" rel="noreferrer">
            <YoutubeIcon className="size-6 hover:text-rose-500" />
          </a>
        </div>
        <p className="mt-3 text-center">
          &copy; {new Date().getFullYear()}{" "}
          <a href="https://prebuiltui.com?utm_source=pixels">ThumbSniper - Anand Mansabdar</a>
        </p>
      </motion.div>
    </footer>
  );
