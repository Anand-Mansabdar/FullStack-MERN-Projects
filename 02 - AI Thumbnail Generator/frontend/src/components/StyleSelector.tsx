...
const StyleSelector = ({
  ...
  const styleDescriptions: Record<ThumbnailStyle, string> = {
    ...
    Minimalistic: "Clean, simple, lots of white space",
  ...
  return (
    <div className="relative space-y-3 dark">
      ...
      {isOpen && (
        <div className="absolute bottom-0 w-full z-50 border mt-1 rounded-md border-white/12 bg-black/20 backdrop-blur-3xl shadow-lg">
